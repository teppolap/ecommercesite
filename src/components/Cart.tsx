...
const Cart = () => {
  ...
  useEffect(() => {
    console.log("Cart component session status:", status);
    console.log("Cart component session data:", session);
  ...
  const createCheckout = async () => {
    if (session?.user) {
      ...
      const response = await fetch("https://top-shelf-market.vercel.app/api/checkout", {
        method: "POST",
